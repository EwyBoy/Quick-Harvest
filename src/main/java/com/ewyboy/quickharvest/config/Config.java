...
public class Config {
    ...
    static {
        ...
        WHEAT = new HarvesterConfig("wheat", serverSpec, true, false, true, ToolActions.HOE_DIG, "minecraft:wheat_seeds", ImmutableList.of());
        CARROTS = new HarvesterConfig("carrots", serverSpec, true, false, true, ToolActions.HOE_DIG, "minecraft:carrot", ImmutableList.of());
        POTATOES = new HarvesterConfig("potatoes", serverSpec, true, false, true, ToolActions.HOE_DIG, "minecraft:potato", ImmutableList.of());
        BEETROOTS = new HarvesterConfig("beetroots", serverSpec, true, false, true, ToolActions.HOE_DIG, "minecraft:beetroot_seeds", ImmutableList.of());
        CHORUS = new HarvesterConfig("chorus", serverSpec, true, false, true, ToolActions.AXE_DIG, "minecraft:chorus_flower", ImmutableList.of());
        COCOA = new HarvesterConfig("cocoa", serverSpec, true, false, true, ToolActions.AXE_DIG, "minecraft:cocoa_beans", ImmutableList.of());
        ...
        CACTUS = new HarvesterConfig("cactus", serverSpec, true, false, false, ToolActions.AXE_DIG, "minecraft:air", ImmutableList.of());
        MELON = new HarvesterConfig("melon", serverSpec, true, false, false, ToolActions.AXE_DIG, "minecraft:air", ImmutableList.of());
        PUMPKIN = new HarvesterConfig("pumpkin", serverSpec, true, false, false, ToolActions.AXE_DIG, "minecraft:air", ImmutableList.of(Items.SHEARS));
        NETHER_WART = new HarvesterConfig("nether_wart", serverSpec, true, false, true, ToolActions.HOE_DIG, "minecraft:nether_wart", ImmutableList.of());
