...
public abstract class AbstractHarvester extends Harvester {
    ...
    @Override
    public boolean isTryingToBuild(PlayerEntity player, Hand hand, ServerWorld level, BlockPos pos) {
        return (player.getItemInHand(hand).getItem().equals(level.getBlockState(pos).getBlock().asItem()));
    }
